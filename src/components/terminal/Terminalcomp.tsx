    ...
    const processCommand = async (e: KeyboardEvent<HTMLInputElement>) => {
        ...
        switch (command) {
            ...
            case "cat .open_me":
                ...
                break;
            case "Saif":
                output = "Hello there! I am Saif, a Full Stack Developer experienced in the MERN stack, currently pursuing my Bachelor's  in Computer Science and Engineering. Type about to know more about me";
                break;
            case "neofetch":
            ...
            case "muxik":
                ...
                break;
            case "synthia":
                window.location.href = "https://github.com/mohdsaif0026/synthia";
                output = "";
                break;
            case "clear":
                setCommands([]);
