        ...
        <section className=" p-4 w-full lg:max-w-[50%] lg:m-auto">
            <div className="flex flex-col gap-4">
                <h1 className=" text-3xl lg:text-5xl font-bold tracking-wide mt-7">
                    Hi. I&apos;m{" "}
                    <a href="https://twitter.com/mdsaif0026" rel="noopener noreferrer" target="_blank" className=" text-balance text-blue-500">
                        @sh17va{" "}
                    </a>
                    🤟
                </h1>
                ...
                <p className="text-md lg:text-2xl flex flex-col gap-2 whitespace-break-spaces font-normal">
                    <span>
                        Hey , stranger 👋 I&apos;m Mohd Saif Ansari, a self-taught full stack developer from Prayagraj Uttar Pradesh India. I&apos;m a student currently pursuing my bachelors in <span className=" font-bold">Computer Science and Technology</span>, I love build software that solves real world problems which is probably why everything I build is{" "}
                        <a href="https://github.com/mohdsaif0026" target="_blank" rel="noopener noreferrer" className=" font-bold text-green-500">
                            Open Source
                        </a>
                        .
                    </span>
                ...
                <div className="flex gap-2 flex-wrap mt-2 mb-2 items-center">
                    <a href="https://github.com/mohdsaif0026" target="_blank" rel="noopener noreferrer">
                        <GitHubLogoIcon className=" h-6 lg:h-10 w-8 lg:w-8 duration-200 hover:-translate-y-2 cursor-pointer" />
                    </a>
                    <a href="https://twitter.com/mdsaif0026" target="_blank" rel="noopener noreferrer">
                        <TwitterLogoIcon className=" h-6 lg:h-10 w-8 lg:w-8 duration-200 hover:-translate-y-2 cursor-pointer" />
                    </a>
                    <a href="mailto:hello@mohdsaif.com?body=Hello" target="_blank" rel="noopener noreferrer">
                        <MailPlus className=" h-6 lg:h-10 w-8 lg:w-8 duration-200 hover:-translate-y-2 cursor-pointer" />
                    </a>
                    <a href="https://instagram.com/Saifhereig" target="_blank" rel="noopener noreferrer">
                ...
                <p className=" text-md lg:text-2xl whitespace-break-spaces font-normal">
                    ...
                    <a href="mailto:hello@mohdsaif.com?body=Hello" rel="noopener noreferrer" target="_blank" className=" text-blue-500 italic font-bold">
                        hello@mohdsaif.com
                    </a>
                    ) and{" "}
                    <a href="https://twitter.com/mdsaif0026" rel="noopener noreferrer" target="_blank" className="font-bold italic text-blue-500">
                        Twitter
                    </a>{" "}
